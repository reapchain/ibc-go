...
func TestParseClientIdentifier(t *testing.T) {
	testCases := []struct {
		...
		{"valid 0", "reapchain-0", "reapchain", 0, true},
		{"valid 1", "reapchain-1", "reapchain", 1, true},
		{"valid solemachine", "solomachine-v1-1", "solomachine-v1", 1, true},
		{"valid large sequence", types.FormatClientIdentifier("reapchain", math.MaxUint64), "reapchain", math.MaxUint64, true},
		{"valid short client type", "t-0", "t", 0, true},
		// one above uint64 max
		{"invalid uint64", "reapchain-18446744073709551616", "reapchain", 0, false},
		// uint64 == 20 characters
		{"invalid large sequence", "reapchain-2345682193567182931243", "reapchain", 0, false},
		{"missing dash", "tendermint0", "reapchain", 0, false},
		{"blank id", "               ", "    ", 0, false},
		{"empty id", "", "", 0, false},
		{"negative sequence", "reapchain--1", "reapchain", 0, false},
		{"invalid format", "reapchain-tm", "reapchain", 0, false},
		{"empty clientype", " -100", "reapchain", 0, false},
	}
