...
[Binding to transfer
port](https://github.com/reapchain/ibc-go/blob/main/modules/apps/transfer/types/genesis.go)

[Sending transfer
packets](https://github.com/reapchain/ibc-go/blob/main/modules/apps/transfer/keeper/relay.go)

[Implementing IBC
callbacks](https://github.com/reapchain/ibc-go/blob/main/modules/apps/transfer/module.go)
