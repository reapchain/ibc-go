...
// Status returns the status of the reapchain client.
// The client may be:
...
func (cs ClientState) Validate() error {
	...
	// between the reapchain version being run by the counterparty chain
	// and the reapchain version used by this light client.
	...
	if cs.LatestHeight.RevisionHeight == 0 {
		return sdkerrors.Wrapf(ErrInvalidHeaderHeight, "reapchain client's latest height revision height cannot be zero")
	}
