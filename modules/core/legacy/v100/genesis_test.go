...
import (
	...
	clientv100 "github.com/reapchain/ibc-go/modules/core/02-client/legacy/v100"
	...
	"github.com/reapchain/ibc-go/modules/core/legacy/v100"
...
func (suite *LegacyTestSuite) TestMigrateGenesisSolomachine() {
	...
	// solo machine clients must come before reapchain in expected
	...
	// NOTE: genesis time isn't updated since we aren't testing for reapchain consensus state pruning
