...
interface](https://github.com/reapchain/ibc-go/tree/main/modules/core/05-port/types/module.go). This
...
simple version negotation is implemented in the [ibc-transfer module](https://github.com/reapchain/ibc-go/tree/main/modules/apps/transfer/module.go).
...
[channel types](https://github.com/reapchain/ibc-go/tree/main/modules/core/04-channel/types).

While modules may choose arbitrary acknowledgement structs, a default acknowledgement types is provided by IBC [here](https://github.com/reapchain/ibc-go/blob/main/proto/ibc/core/channel/v1/channel.proto):
...
[Binding to transfer
port](https://github.com/reapchain/ibc-go/blob/main/modules/apps/transfer/keeper/genesis.go)

[Sending transfer
packets](https://github.com/reapchain/ibc-go/blob/main/modules/apps/transfer/keeper/relay.go)

[Implementing IBC
callbacks](https://github.com/reapchain/ibc-go/blob/main/modules/apps/transfer/ibc_module.go)
