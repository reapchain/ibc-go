...
// source: ibc/lightclients/reapchain/v1/reapchain.proto
...
type ConsensusState struct {
	...
	NextValidatorsHash github_com_tendermint_tendermint_libs_bytes.HexBytes `protobuf:"bytes,3,opt,name=next_validators_hash,json=nextValidatorsHash,proto3,casttype=github.com/reapchain/reapchain-core/libs/bytes.HexBytes" json:"next_validators_hash,omitempty" yaml:"next_validators_hash"`
}
...
func init() {
	proto.RegisterType((*ClientState)(nil), "ibc.lightclients.reapchain.v1.ClientState")
	proto.RegisterType((*ConsensusState)(nil), "ibc.lightclients.reapchain.v1.ConsensusState")
	proto.RegisterType((*Misbehaviour)(nil), "ibc.lightclients.reapchain.v1.Misbehaviour")
	proto.RegisterType((*Header)(nil), "ibc.lightclients.reapchain.v1.Header")
	proto.RegisterType((*Fraction)(nil), "ibc.lightclients.reapchain.v1.Fraction")
}

func init() {
	proto.RegisterFile("ibc/lightclients/reapchain/v1/reapchain.proto", fileDescriptor_c6d6cf2b288949be)
}
