...
import (
	...
	"github.com/reapchain/ibc-go/modules/core/02-client/legacy/v100"
...
// only test migration for reapchain clients
// ensure all expired consensus states are removed from reapchain client stores
