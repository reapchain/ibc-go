...
For example, changing the go package version from `v2` to `v3` bumps the import from `github.com/reapchain/ibc-go/v2` to `github.com/reapchain/ibc-go/v3`.
...
Attempting to import two versions of ibc-go, such as `github.com/reapchain/ibc-go/v2` and `github.com/reapchain/ibc-go/v3`, will result in multiple issues. 
...
`github.com/reapchain/ibc-go/v2` cannot be imported with any other ibc-go version

`github.com/reapchain/ibc-go/v3` cannot be imported with any previous ibc-go versions

`github.com/reapchain/ibc-go/v4` may be imported with ibc-go versions v3+

`github.com/reapchain/ibc-go/v5` may be imported with ibc-go versions v3+
